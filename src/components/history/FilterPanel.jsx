      ...
      <Section label="Date Range" defaultOpen>
        <div className="space-y-1.5">
          ...
          <DatePicker
            ...
            className="w-full bg-white border border-[rgba(27,108,168,0.25)] rounded px-2 py-1 text-[11px] font-mono text-[#1A1F36] placeholder-gray-400 focus:outline-none focus:border-accent"
            ...
            <button
              ...
              className={`text-[10px] font-mono px-2 py-1 rounded border transition-all ${
                filters.outcome === opt.value
                  ...
                  : 'border-accent/30 text-gray-500 hover:border-accent/60 hover:text-[#1A1F36] hover:bg-gray-50'
              }`}
            >
              {opt.label}
            </button>
            ...
            <button
              ...
              className={`text-[10px] font-mono px-2 py-0.5 rounded border transition-all ${
                (filters.orbits || []).includes(o)
                  ...
                  : 'border-accent/20 text-gray-500 hover:text-[#1A1F36] hover:border-accent/40 hover:bg-gray-50'
              }`}
            >
              {o}
            </button>
      ...
      <Section label="Payload Cap. (kg)" open={payloadOpen} onToggle={() => setPayloadOpen(o => !o)}>
        <div className="px-1 space-y-2">
          ...
          <div className="flex justify-between text-[9px] font-mono text-gray-500">
            <span>0 kg</span>
            <span className="text-[#1A1F36]">{(filters.payload_max ?? 65000).toLocaleString()} kg</span>
            <span>65,000 kg</span>
          </div>
          <input
            type="range"
          ...
          />
          <div className="flex justify-between text-[9px] font-mono text-gray-500">
            <span>Min: <span className="text-[#1A1F36]">{(filters.payload_min ?? 0).toLocaleString()} kg</span></span>
          </div>
        </div>
      </Section>
    </aside>
